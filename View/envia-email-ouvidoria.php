...
$emaildestinatario = 'ouvidoria@qualitex.com.br'; // Digite seu e-mail aqui, lembrando que o e-mail deve estar em seu servidor web
...
$assunto = "Email recebido por meio da ouvidoria - Site qualitex. Data: " . $date['mday'].'/'.$date['mon'].'/'.$date['year'] . " -- " . $date['seconds'] ;
...
if($envio){
	...
	echo("<script>location.href='ouvidoria.html'</script>");
}
?>
