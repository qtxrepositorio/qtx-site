    ...
    <div class="container">
        ...
        <div class="col-md-6">
            ...
            <div class="tab-pane fade in active" id="tab-4">
                <h4 class="classic-title"><span>Limpe e conservação predial e de áreas verdes</span></h4>
                <p>
                    <li>
...
.wrapper .column:nth-child(1) .inner {
    background-image: url('..//webroot/img/grids/cleaning-predial-green-conservation/1.jpg');
}
.wrapper .column:nth-child(2) .inner {
    background-image: url('..//webroot/img/grids/cleaning-predial-green-conservation/2.jpg');
}
.wrapper .column:nth-child(3) .inner {
    background-image: url('..//webroot/img/grids/cleaning-predial-green-conservation/3.jpg');
}
.wrapper .column:nth-child(4) .inner {
    background-image: url('..//webroot/img/grids/cleaning-predial-green-conservation/4.jpg');
}
.wrapper .column:nth-child(5) .inner {
    background-image: url('..//webroot/img/grids/cleaning-predial-green-conservation/5.jpg');
}
.wrapper .column:nth-child(6) .inner {
    background-image: url('..//webroot/img/grids/cleaning-predial-green-conservation/6.jpg');
}
.wrapper .column:nth-child(7) .inner {
    background-image: url('..//webroot/img/grids/cleaning-predial-green-conservation/7.jpg');
}
.wrapper .column:nth-child(8) .inner {
    background-image: url('..//webroot/img/grids/cleaning-predial-green-conservation/8.jpg');
}
.wrapper .column:nth-child(9) .inner {
    background-image: url('..//webroot/img/grids/cleaning-predial-green-conservation/9.jpg');
}
.wrapper .column:nth-child(10) .inner {
    background-image: url('..//webroot/img/grids/cleaning-predial-green-conservation/10.jpg');
}
.wrapper .column:nth-child(11) .inner {
    background-image: url('..//webroot/img/grids/cleaning-predial-green-conservation/11.jpg');
}
.wrapper .column:nth-child(12) .inner {
    background-image: url('..//webroot/img/grids/cleaning-predial-green-conservation/12.jpg');
}
.wrapper .column:nth-child(13) .inner {
    background-image: url('..//webroot/img/grids/cleaning-predial-green-conservation/13.jpg');
}
</style>
