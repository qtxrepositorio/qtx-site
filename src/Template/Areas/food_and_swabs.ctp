    ...
    <div class="container">
        ...
        <div class="col-md-6">
            <div class="tab-pane fade in active" id="tab-4">
                <h4 class="classic-title"><span>Alimentos e swabs</span></h4>
                <p>
                    A QUALITEX está engajada apoiando a Política Nacional de Alimentação e Nutrição.
                    A caracterização dos alimentos e suporte analítico ao controle de processo
                    possibilita a segurança alimentar e nutricional. A composição dos alimentos,
                    os cuidados de conservação e o manejo em todas as fases até o consumidor final
                    são itens fundamentais para o sucesso das políticas públicas voltadas a sadia
                    qualidade de vida. O Laboratório Qualitex atua no monitoramento analítico dos
                    alimentos, utensílios e manipuladores em relação a parâmetros de controle
                    biológico e na avaliação analítica da composição nutricional dos alimentos
                    em relação ao parâmetros legais.
                </p>
