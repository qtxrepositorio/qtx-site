...
$assunto = "Pedido on-line. Data: " . $date['mday'].'/'.$date['mon'].'/'.$date['year'] . " -- " . $date['seconds'] ;
...
$Mailer->From = 'workflow@qualitex.com.br';

$Mailer->FromName = 'Setor Comercial';

$Mailer->Subject = 'Wokflow - pedido on-line '. rand(0, 10000);
